"""Use reguular expressions to parse emails in a txt file.
"""
import re
...
def main(path):
    ...
    for email in serverObj.emails[:5]: 
    ...
    print("Total parsed emails: ", len(serverObj.emails[1:]))
...
def parse_args(args_list):
    ...
    Args: 
        args_list(str): list of strings containing command line args
